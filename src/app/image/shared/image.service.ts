...
export class ImageService{
    ...
    myMethod(data) {
          ...
          IMAGES.push({"id":i,"caption":d[i].title,"url":'https://farm'+p.farm+'.staticflickr.com/'+p.server+'/'+p.id+'_'+p.secret+'.jpg'})
          i++;
...
// const IMAGES =[
//     {"id":1, "category": "boats", "caption": "pizza", "url":"https://farm8.staticflickr.com/7904/47010889231_571ffaefa8.jpg"},
